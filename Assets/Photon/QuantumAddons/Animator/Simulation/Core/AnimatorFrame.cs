namespace Quantum.Addons.Animator
{
  ...
  public struct AnimatorFrame
  {
    ...
    public AnimatorFrame(FPQuaternion rotation)
    {
      Id = 0;
      Time = 0;
    ...
    public static AnimatorFrame operator +(AnimatorFrame animatorFrameA, AnimatorFrame animatorFrameB)
    {
      return new AnimatorFrame()
      {
        ...
        Rotation = FPQuaternion.Product(animatorFrameB.Rotation, animatorFrameA.Rotation),
    ...
    public static AnimatorFrame operator -(AnimatorFrame animatorFrameA, AnimatorFrame animatorFrameB)
    {
      return new AnimatorFrame()
      {
        ...
        Rotation = FPQuaternion.Product(animatorFrameB.Rotation, animatorFrameA.Rotation.Inverted),
    ...
    public static AnimatorFrame Lerp(AnimatorFrame animatorFrameA, AnimatorFrame animatorFrameB, FP value)
    {
      ...
      var rotationYA = animatorFrameA.RotationY;
      var rotationYB = animatorFrameB.RotationY;
      
      if (rotationYA < 0 && animatorFrameB.RotationY > 0) rotationYA *= -1;
      if (rotationYA > 0 && animatorFrameB.RotationY < 0) rotationYB *= -1;
