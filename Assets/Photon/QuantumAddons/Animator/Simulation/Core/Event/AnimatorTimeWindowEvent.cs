namespace Quantum.Addons.Animator
{
  ...
  public unsafe class AnimatorTimeWindowEvent : AnimatorEvent
  {
    ...
    public override bool Evaluate(Frame f, AnimatorComponent* animatorComponent, LayerData* layerData, AnimatorStateType stateType)
    {
      ...
      if (layerData->Time >= Time && layerData->Time <= EndTime)
      {
        ...
        if (base.Evaluate(f, animatorComponent, layerData, stateType))
        {
