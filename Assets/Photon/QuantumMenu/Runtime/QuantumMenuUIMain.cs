    ...
    public partial class QuantumMenuUIMain : QuantumMenuUIScreen
    {
      ...
      _quitButton.gameObject.SetActive(false);
        ...
        protected virtual async void OnPlayButtonPressed()
        {
            ...
            // Set flag to load character select screen after connection
            ConnectionArgs.IsCharacterSelectMode = true;
        ...
        protected virtual async void OnQuickMatchButtonPressed()
        {
            // Load CharacterSelectScene additively (keep main menu UI? or replace?)
            await UnityEngine.SceneManagement.SceneManager.LoadSceneAsync("CharacterSelectScene",
                UnityEngine.SceneManagement.LoadSceneMode.Additive);

            Controller.Show<QuantumMenuUICharacterSelect>();
        }
