...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct StateRequest {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(4)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct ActionStateMachine : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 13249;
        hash = hash * 31 + SpotDodgeCooldown.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ActionStateMachine*)ptr;
        FP.Serialize(&p->SpotDodgeCooldown, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct CharacterMaster : Quantum.IComponent {
    ...
    [FieldOffset(4)]
    [ExcludeFromPrototype()]
    public QListPtr<StateRequest> StateRequests;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 859;
        ...
        hash = hash * 31 + CurrentStatePriority.GetHashCode();
        hash = hash * 31 + StateTimer.GetHashCode();
        hash = hash * 31 + IdleConfig.GetHashCode();
        hash = hash * 31 + RunConfig.GetHashCode();
        hash = hash * 31 + JumpConfig.GetHashCode();
        hash = hash * 31 + MidAirConfig.GetHashCode();
        hash = hash * 31 + AttackConfig.GetHashCode();
        hash = hash * 31 + StunConfig.GetHashCode();
        hash = hash * 31 + SpotDodgeConfig.GetHashCode();
        hash = hash * 31 + DashConfig.GetHashCode();
        hash = hash * 31 + StateRequests.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      StateRequests = default;
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.CharacterMaster*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (CharacterMaster*)ptr;
        serializer.Stream.Serialize(&p->CurrentStatePriority);
        QList.Serialize(&p->StateRequests, serializer, Statics.SerializeStateRequest);
        ...
        AssetRef.Serialize(&p->JumpConfig, serializer);
        AssetRef.Serialize(&p->MidAirConfig, serializer);
        AssetRef.Serialize(&p->RunConfig, serializer);
        AssetRef.Serialize(&p->SpotDodgeConfig, serializer);
        AssetRef.Serialize(&p->StunConfig, serializer);
  ...
  public unsafe partial struct GameStateMachine : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + CurrentStateConfig.GetHashCode();
        hash = hash * 31 + StateTimer.GetHashCode();
        hash = hash * 31 + IsTransitioning.GetHashCode();
        hash = hash * 31 + LobbyConfig.GetHashCode();
        hash = hash * 31 + LoadingConfig.GetHashCode();
        hash = hash * 31 + RoundActiveConfig.GetHashCode();
        hash = hash * 31 + RoundEndConfig.GetHashCode();
        hash = hash * 31 + MatchEndConfig.GetHashCode();
        hash = hash * 31 + CutsceneConfig.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (GameStateMachine*)ptr;
        serializer.Stream.Serialize((Int32*)&p->CurrentState);
        QBoolean.Serialize(&p->IsTransitioning, serializer);
        AssetRef.Serialize(&p->CurrentStateConfig, serializer);
        AssetRef.Serialize(&p->CutsceneConfig, serializer);
        AssetRef.Serialize(&p->LoadingConfig, serializer);
        AssetRef.Serialize(&p->LobbyConfig, serializer);
        AssetRef.Serialize(&p->MatchEndConfig, serializer);
        AssetRef.Serialize(&p->RoundActiveConfig, serializer);
        AssetRef.Serialize(&p->RoundEndConfig, serializer);
        FP.Serialize(&p->StateTimer, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct Health : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + IsInvincible.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        QBoolean.Serialize(&p->IsInvincible, serializer);
  ...
  public unsafe partial struct KCC2D : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + _gravityModifier.GetHashCode();
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        FP.Serialize(&p->_gravityModifier, serializer);
  ...
  public unsafe partial struct StatusStateMachine : Quantum.IComponent {
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + HitBoxConfig.GetHashCode();
        hash = hash * 31 + Attacker.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (StatusStateMachine*)ptr;
        QBoolean.Serialize(&p->IsStunned, serializer);
        AssetRef.Serialize(&p->HitBoxConfig, serializer);
  ...
  public unsafe partial interface ISignalOnAnimatorSetVelocity : ISignal {
    void OnAnimatorSetVelocity(Frame f, EntityRef entity, FPVector2 velocity);
  }
  ...
  public unsafe partial interface ISignalOnDamageDealt : ISignal {
    void OnDamageDealt(Frame f, EntityRef target, AssetRef<HitBoxConfig> HitBoxConfig, EntityRef source);
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.ActionStateMachine>();
      BuildSignalsArrayOnComponentRemoved<Quantum.ActionStateMachine>();
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnAnimatorSetVelocity(EntityRef entity, FPVector2 velocity) {
        var array = _f._ISignalOnAnimatorSetVelocitySystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnAnimatorSetVelocity(_f, entity, velocity);
          }
        }
      }
      public void OnAnimatorVelocityLerp(EntityRef entity, FPVector2 startVelocity, FPVector2 endVelocity, FP StartTime, FP EndTime, FP CurrentTime) {
        var array = _f._ISignalOnAnimatorVelocityLerpSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnAnimatorVelocityLerp(_f, entity, startVelocity, endVelocity, StartTime, EndTime, CurrentTime);
          }
        }
      }
      ...
      public void OnDamageDealt(EntityRef target, AssetRef<HitBoxConfig> HitBoxConfig, EntityRef source) {
        var array = _f._ISignalOnDamageDealtSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnDamageDealt(_f, target, HitBoxConfig, source);
          }
        }
      }
  ...
  public unsafe partial class Statics {
    ...
    public static FrameSerializer.Delegate SerializeStateRequest;
    ...
    static partial void InitStaticDelegatesGen() {
      ...
      SerializeStateRequest = Quantum.StateRequest.Serialize;
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.ActionStateMachine), Quantum.ActionStateMachine.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.GameStateMachine), Quantum.GameStateMachine.SIZE);
      typeRegistry.Register(typeof(Quantum.GameStateType), 4);
    ...
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.GameStateType>();
