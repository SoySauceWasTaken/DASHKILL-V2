namespace DashKill
{
    ...
    public class ConnectionHudEntry : QuantumSceneViewComponent<GameViewContext>
    {
        [Header("References")]
        /// <summary>
        ...
        private EventOnPlayerDisconnected _deathEvent;

        /// <summary>
        /// Sets the death event data for this entry.
        /// </summary>
        public EventOnPlayerDisconnected DeathEvent
        {
        ...
        {
            var destroyedCharacter = frame.Get<PlayerLink>(_deathEvent.DisconnectedPlayer);
            var destroyedCharacterPlayer = frame.GetPlayerData(destroyedCharacter.Player);

            var sourceCharacter = frame.Get<PlayerLink>(_deathEvent.DisconnectedPlayer);
